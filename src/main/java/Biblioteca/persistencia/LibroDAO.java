...
public class LibroDAO {
    ...
    public ArrayList<Libro> select() throws SQLException{
        ...
        try {
            // Preparar la sentencia SQL para buscar usuarios por nombre (usando LIKE para búsqueda parcial).
            ps = conn.connect().prepareStatement("SELECT * FROM Libros");
    ...
    public ArrayList<Libro> select(String titulo) throws SQLException{
        ArrayList<Libro> records  = new ArrayList<>();

        try {
            // Preparar la sentencia SQL para buscar usuarios por nombre (usando LIKE para búsqueda parcial).
            ps = conn.connect().prepareStatement("SELECT * FROM Libros WHERE Titulo LIKE + ? + '%'"
            );
